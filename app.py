...
styles = {
    ...
    "span": {
        ...
        "padding": "0.5rem 0.75rem",  # Consistent padding inside each heading
        ...
        "min-width": "fit-content",  # Take only the space needed
    ...
    "hover": {
        "background-color": "rgba(252, 211, 172)",  # Background color on hover
    },
    "img": {
...
icons = {
    ...
    "Tissue Specific Expression": ":material/biotech:",
    "RNA-type": ":material/ballot:",
    "miRNA-target": ":material/merge_type:",
    "Transcription Factors": ":material/account_tree:",
    "PPI": ":material/shape_line:",
    "Localization": ":material/pin_drop:",
    "GO-KEGG": ":material/bubble_chart:",
    "ORTHOLOGS/PARALOGS": ":material/compare_arrows:",
    "ABOUT US": ":material/info:",
    "LOGIN": ":material/security:"
}

if "current_page" not in st.session_state:
    st.session_state.current_page = "HOME"
page = st_navbar(pages, logo_path=logo_path, styles=styles, options=options,logo_page="HOME",icons=icons)
