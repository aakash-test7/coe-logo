...
def advanced_search():
    ...
    header_styled("Query Search","This search allows users to retrieve the gene related information for its functional and structured annotation via multiple research parameters including Gene ID, Pfam domain, Gene symbol, subceellular localization and model-based prediction results. The results can be combined using set operations like Union, Intersection, Difference and Symmetric Difference to refine the search results based on specific criteria.")
